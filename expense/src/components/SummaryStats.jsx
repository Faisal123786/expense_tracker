...
const SummaryStats = ({ totalIncome = 0, totalExpenses = 0, balance = 0 }) => {
  return (
    <div className="space-y-4 sm:space-y-6">
      {/* Top row: two cards side-by-side on md+ with equal width & height */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-stretch">
        {/* Main Balance Card */}
        <Card className="h-full flex flex-col bg-gradient-to-br from-purple-600/20 to-pink-600/20 border-purple-500/30">
